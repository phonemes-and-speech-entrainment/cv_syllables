...
dataCond <- read.csv("pow4_cond.csv")
condLevels <-c(1:15)
...
dataConsonants1 <- read.csv("pow4_consonants1.csv")
...
consonants1_ttests=read.csv("pow4_consonants1_ttests.csv")
print(pairwise.t.test(consonants1_ttests$Power, consonants1_ttests$Consonant, p.adj = "bonferroni", paired = TRUE))

dataConsonants2 <- read.csv("pow4_consonants2.csv")
...
print(summary(analysis4, multivariate=FALSE))

consonants2_ttests=read.csv("pow4_consonants2_ttests.csv")

print(pairwise.t.test(consonants2_ttests$Power, consonants2_ttests$Consonant, p.adj = "bonferroni",paired = TRUE))