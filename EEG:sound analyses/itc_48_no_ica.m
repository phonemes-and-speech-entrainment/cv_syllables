...
sditc12=std(meanitc12,[],2);
sem12=sditc12./sqrt(size(meanitc12,2));

sditc16=std(meanitc16,[],2);
sem16=sditc16./sqrt(size(meanitc16,2));

mean4=mean(meanitc4,2);
mean8=mean(meanitc8,2);
mean12=mean(meanitc12,2);
mean16=mean(meanitc16,2);
...
[rho,p] = corr(mean4,mean8)
[rho,p] = corr(mean4,mean12)
[rho,p] = corr(mean4,mean16)
[rho,p] = corr(mean8,mean12)
[rho,p] = corr(mean8,mean16)
[rho,p] = corr(mean12,mean16)