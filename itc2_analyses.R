...
dataCond <- read.csv("itc2_cond.csv")
condLevels <-c(1:15)
...
dataConsonants1 <- read.csv("itc2_consonants1.csv")
...
consonants1_ttests=read.csv("itc2_consonants1_ttests.csv")
print(pairwise.t.test(consonants1_ttests$ITC, consonants1_ttests$Consonant, p.adj = "bonferroni", paired = TRUE))

dataConsonants2 <- read.csv("itc2_consonants2.csv")
...
consonants2_ttests=read.csv("itc2_consonants2_ttests.csv")

print(pairwise.t.test(consonants2_ttests$ITC, consonants2_ttests$Consonant, p.adj = "bonferroni",paired = TRUE))